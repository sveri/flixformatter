...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "singleLineComment$ebnf$1", "symbols": ["singleLineComment$ebnf$1", /[ \(\),\*\w/\.\`\";:\-_]/], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "multiLineComment$ebnf$1", "symbols": ["multiLineComment$ebnf$1", /[ \(\),\*\w/\.\`\";:\-_\n]/], "postprocess": (d) => d[0].concat([d[1]])},
