...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "comment$string$1", "symbols": [{"literal":"/"}, {"literal":"/"}], "postprocess": (d) => d.join('')},
    {"name": "comment$ebnf$1", "symbols": []},
    {"name": "comment$ebnf$1", "symbols": ["comment$ebnf$1", /[ \w/\.\`]/], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "comment", "symbols": ["_", "comment$string$1", "comment$ebnf$1", /[\n]/], "postprocess": d => {return ({type: "comment", text: d[1] + d[2].join("")})}},
    ...
    {"name": "classBody", "symbols": ["classBody$ebnf$1"], "postprocess": d => {console.log("classBody: " + JSON.stringify(flatten(d[0]))); return flatten(d[0])}},
    ...
    {"name": "method", "symbols": ["_", "pubdef", "__", "identifier", "_", "argsWithParenWithType", "_", "colon", "_", "returnType", "_", "assignement", "_", "methodBody", "_"], "postprocess": d => {return { type: "method", pubdef: d[1], name: d[3], args: d[5], returnType: d[9], body: d[13]}}},
    ...
    {"name": "longMethodBody", "symbols": ["longMethodBody$ebnf$1"]},
    ...
    {"name": "import", "symbols": ["_", "import$subexpression$1", "identifier", "import$ebnf$1", "lparen", "identifier", "rparen", {"literal":";"}]},
    ...
    {"name": "pubdef", "symbols": ["pubdef$string$2"], "postprocess": d => {return d[0]}},
