...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "comment$string$2", "symbols": [{"literal":"/"}, {"literal":"*"}], "postprocess": (d) => d.join('')},
    {"name": "comment$ebnf$2", "symbols": []},
    {"name": "comment$ebnf$2", "symbols": ["comment$ebnf$2", /[ \w/\.\`\n]/], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "comment$string$3", "symbols": [{"literal":"*"}, {"literal":"/"}], "postprocess": (d) => d.join('')},
    {"name": "comment", "symbols": ["_", "comment$string$2", "comment$ebnf$2", "comment$string$3"], "postprocess": d => {return ({type: "multiLine", text: d[2].join("")})}},
